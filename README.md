...
**초보자분들을 위한 상세한 가이드**를 준비했습니다! Bayesian 추론이나 Gaussian Process가 처음이시라면, [초보자 가이드 (BEGINNER_GUIDE.md)](BEGINNER_GUIDE.md)를 먼저 읽어보시기 바랍니다. 핵심 개념부터 단계별 학습 경로까지 친절하게 설명되어 있습니다.
